...
vault write identity/oidc/provider/my-provider \
    allowed_client_ids="${GRAFANA_CLIENT_ID}" \
...
Environment     : Vault / Grafana OIDC
----------------------------------------------------------------------

1. ADMINISTRATOR ACCESS (Grafana Admin)
--------------------------------------------------------
...
2. STANDARD USER ACCESS (Grafana User)
-------------------------------------------------------
...
----------------------------------------------------------------------
Note: To log in to Grafana via OIDC, use the credentials 
